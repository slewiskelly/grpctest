...
const (
	ReverseService_Reverse_FullMethodName = "/reverse.v1.ReverseService/Reverse"
)
...
func (c *reverseServiceClient) Reverse(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
...
func (UnimplementedReverseServiceServer) Reverse(context.Context, *Request) (*Response, error) {
...
func _ReverseService_Reverse_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverseServiceServer).Reverse(ctx, req.(*Request))
	}
...
var ReverseService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "reverse.v1.ReverseService",
	...
	Metadata: "reverse/v1/reverse.proto",
}
